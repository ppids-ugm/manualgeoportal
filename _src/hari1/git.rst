...
.. image:: ../../_static/images/git_new-repo.jpg
  :align: center

|

4. Beri tanda centang pada **Initialize this repository with README**.

5. Sekarang, anda telah memiliki sebuah repository baru. Anda dapat mengisikan project anda pada repository ini. Sebagai langkah pertama, buat file baru (klik tanda ``+`` di samping nama repository anda), kemudian copykan kode berikut:
